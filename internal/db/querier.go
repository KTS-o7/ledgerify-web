...
type Querier interface {
	...
	CreateSip(ctx context.Context, arg CreateSipParams) (Sip, error)
	...
	DeleteSip(ctx context.Context, arg DeleteSipParams) error
	...
	GetSipByID(ctx context.Context, id pgtype.UUID) (Sip, error)
	...
	// SIPs
	ListSipsByUser(ctx context.Context, userID pgtype.UUID) ([]Sip, error)
	// Tags
	...
	SumPaidAmount(ctx context.Context, loanID pgtype.UUID) (pgtype.Numeric, error)
	// Recalc helpers: sum of paid/partial principal + amount components for a loan
	SumPaidPrincipal(ctx context.Context, loanID pgtype.UUID) (pgtype.Numeric, error)
	...
	UpdateInvestmentComputed(ctx context.Context, arg UpdateInvestmentComputedParams) error
	...
	UpdateLoanComputed(ctx context.Context, arg UpdateLoanComputedParams) error
	UpdateSavingsGoal(ctx context.Context, arg UpdateSavingsGoalParams) (SavingsGoal, error)
	UpdateSip(ctx context.Context, arg UpdateSipParams) (Sip, error)
	UpdateSipCorpus(ctx context.Context, arg UpdateSipCorpusParams) error
