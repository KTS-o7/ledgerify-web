  ...
  return (
    <>
      <PageHeader title="Accounts" actions={
        <button type="button" aria-label="Add account" class="w-10 h-10 flex items-center justify-center rounded-full bg-surface text-text active:scale-95 transition-transform">
          <Plus size={20} />
        </button>
      } />
