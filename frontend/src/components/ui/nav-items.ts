import { LayoutDashboard, Wallet, PieChart, Receipt, Target, TrendingUp, Landmark, ShieldCheck, BarChart3, FileText, FileUp, FileDown, Settings, Tag, Tags, PiggyBank, Coins, Plug, RotateCw } from "lucide-solid";
...
export const secondaryNavItems: NavItem[] = [
  ...
  { path: "/mcp", label: "MCP Connect", icon: Plug, section: "secondary" },
